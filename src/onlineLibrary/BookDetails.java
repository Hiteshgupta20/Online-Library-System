...
public class BookDetails extends JFrame implements ActionListener{
    ...
    public BookDetails() {
    	...
    	ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("onlineLibrary/icons/eight.png"));
    	...
    	ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("onlineLibrary/icons/nineth.png"));
    	...
    	ImageIcon i7 = new ImageIcon(ClassLoader.getSystemResource("onlineLibrary/icons/tenth.png"));

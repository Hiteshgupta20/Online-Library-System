...
public class Signup extends JFrame implements ActionListener{
	...
	comboBox.setModel(new DefaultComboBoxModel(new String[] {"Select", "Your NickName?", "Your Lucky Number?",
    ...
    passwordField_2.setBounds(265, 165, 148, 20);
    ...
    public void actionPerformed(ActionEvent ae) {
    	try {
    		...
    		if(ae.getSource()==b1) {
    			...
    			//Replacing the ? with the data entered by the user
    			st.setString(1, textField.getText());
    			st.setString(2, textField_1.getText());
    			st.setString(3, passwordField_2.getText());

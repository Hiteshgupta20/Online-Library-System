...
public class AddStudent extends JFrame implements ActionListener{
	...
	comboBox.setModel(new DefaultComboBoxModel(new String[] {"Select", "Mechanical", "CSE", "IT", "Civil", "Automobile", "EEE", "Other" }));
	...
	comboBox_1.setModel(new DefaultComboBoxModel(new String[] {"Select", "First", "Second", "Third", "Four" }));
	...
	comboBox_2.setModel(
			new DefaultComboBoxModel(new String[] {"Select", "1st", "2nd", "3rd", "4th", "5th", "6th", "7th", "8th" }));
	...
	comboBox_3.setModel(new DefaultComboBoxModel(
			new String[] {"Select", "B.E", "B.Tech", "M.Tech", "MBA", "BBA", "BCA", "B.Sc", "M.Sc", "B.Com", "M.Com" }));
